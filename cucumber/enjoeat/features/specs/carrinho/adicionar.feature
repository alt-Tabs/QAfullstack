...
Funcionalidade: Adicionar ao carrinho
    ...
    Cenario: Adicionar 1 unidade
        ...
        Então deve ser adicionado ao carrinho 1 unidade(s) deste item
        E o valor total deve ser "R$ 8,70"
    ...
    Cenario: Adicionar 2 unidades
        ...
        Então deve ser adicionado ao carrinho 2 unidade(s) deste item
        E o valor total deve ser "R$ 5,00"
    ...
    Cenario: Adicionar varios itens
        ...
        E o valor total deve ser "R$ 29,60"